import{_ as t}from"./AudioPlayer-CbRSxpYt.js";import{_ as d,a as p}from"./AccordionItem-f1dUHkJB.js";import{T as m}from"./TranscriptionExample-D3zuMuU6.js";const l={title:"Components/AudioPlayer",component:t},e={components:{AudioPlayer:t,Accordion:d,AccordionItem:p,TranscriptionExample:m},args:{title:"First of August speech",description:"Hier kommt ein Kurzbeschriebund so weiter Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet.",copyright:"Reuters",url:"https://www.admin.ch/dam/gov/de/Dokumentation/Reden/1-August/DE.MP3",type:"audio/mp3",displayTranscript:!1}},i={render:u=>({components:{AudioPlayer:t,Accordion:d,AccordionItem:p,TranscriptionExample:m},setup:()=>({...u}),template:`
      <div>
        <AudioPlayer
          :url="url"
          :title="title"
