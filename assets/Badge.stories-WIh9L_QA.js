import{_ as f}from"./Badge-B5hKSuSY.js";const S={title:"Components/Badge",component:f,argTypes:{color:{table:{type:{summary:["string: info, error, warning, success, gray, red, yellow, orange, green, blue, indigo, purple, pink"]}},options:["info","error","warning","success","gray","red","yellow","orange","green","blue","indigo","purple","pink"],control:{type:"select"}},size:{table:{type:{summary:["string: base, sm"]}},options:["base","sm"],control:{type:"select"}},icon:{table:{type:{summary:["string: Cancel, Checkmark, undefined"]}},options:["Cancel","Checkmark",null],control:{type:"select"}}}},e={args:{color:"blue",size:"base",icon:void 0,label:"Badge"}},a={render:()=>({template:`
...
}`,...(w=(m=t.parameters)==null?void 0:m.docs)==null?void 0:w.source}}};var y,_,v;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="badge badge--gray badge--icon">
        <span class="badge__text">badge--icon</span>
...
}`,...(v=(_=s.parameters)==null?void 0:_.docs)==null?void 0:v.source}}};const x=["Example","ColorsStates","ColorsOther","Sizes","Icons"],k=Object.freeze(Object.defineProperty({__proto__:null,ColorsOther:n,ColorsStates:a,Example:e,Icons:s,Sizes:t,__namedExportsOrder:x,default:S},Symbol.toStringTag,{value:"Module"}));export{k as B,a as C,e as E,s as I,t as S,n as a};
