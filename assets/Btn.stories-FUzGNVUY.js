import{_ as P}from"./Btn-CifS5esQ.js";const R={title:"Components/Button",component:P,argTypes:{variant:{table:{type:{summary:["string: outline, bare, filled, outline-negative, bare-negative, link, link-negative"]}},options:["outline","bare","filled","outline-negative","bare-negative","link","link-negative"],control:{type:"select"}},size:{table:{type:{summary:["string: sm, base, lg"]}},options:["sm","base","lg"],control:{type:"select"}},icon:{table:{type:{summary:["string: ArrowRight, ArrowLeft, Checkmark"]}},options:["ArrowRight","ArrowLeft","Checkmark"],control:{type:"select"}},iconPos:{table:{type:{summary:["string: none, only, left, right"]}},options:["none","only","left","right"],control:{type:"select"}}}},t={render:i=>({setup:()=>({args:i}),components:{Btn:P},template:`
      <div id="root" style="padding: 3em" class="${i.variant.endsWith("-negative")?"bg--secondary-600":""}">
        <Btn v-bind="args" />
      </div>
    ...
    <button type="button" class="btn btn--outline btn--base">
      ...
      </div>`})};var l,c,p;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => ({
    setup: () => ({
      args
    }),
...
}`,...(p=(c=t.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var u,m,_;n.parameters={...n.parameters,docs:{...(u=n.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <button type="button" class="btn btn--base btn--outline">
        <span class="btn__text">
...
}`,...(_=(m=n.parameters)==null?void 0:m.docs)==null?void 0:_.source}}};var d,g,v;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <button type="button" class="btn btn--base btn--outline">
        <span class="btn__text">
...
}`,...(h=(x=s.parameters)==null?void 0:x.docs)==null?void 0:h.source}}};var B,k,z;a.parameters={...a.parameters,docs:{...(B=a.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <button type="button" class="btn btn--outline btn--sm">
        <span class="btn__text">
...
}`,...(z=(k=a.parameters)==null?void 0:k.docs)==null?void 0:z.source}}};var f,w,S;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <button type="button" class="btn btn--outline btn--base btn--icon-only">
        <svg viewBox="0 0 24 24" class="btn__icon icon icon--base">
