import{_ as g}from"./Card-TiRELwXm.js";import{_ as f}from"./MetaInfo-BhOWf0oO.js";import{_ as b}from"./SvgIcon-CXPG3gok.js";const I={title:"Components/Card",component:g,argTypes:{type:{table:{type:{summary:["string: default, highlight, xCorp, flat, universal, list"]}},options:["default","highlight","xCorp","flat","universal","list"],control:{type:"select"}},layout:{table:{type:{summary:["string: default, image-left, image-right"]}},options:["default","image-left","image-right"],control:{type:"select"}},image:{table:{type:{summary:["string: NoImage, WithImage, WithIcon"]}},options:["NoImage","WithImage","WithIcon"],control:{type:"select"}},header:{table:{type:{summary:["string: NoHeader, WithHeader"]}},options:["NoHeader","WithHeader"],control:{type:"select"}},metaInfo:{table:{type:{summary:["string: NoMetaInfo, WithMetaInfo"]}},options:["NoMetaInfo","WithMetaInfo"],control:{type:"select"}},contentSpecs:{table:{type:{summary:["string: NoContentSpecs, WithContentSpecs"]}},options:["NoContentSpecs","WithContentSpecs"],control:{type:"select"}},contentIcons:{table:{type:{summary:["string: NoContentIcons, WithContentIcons"]}},options:["NoContentIcons","WithContentIcons"],control:{type:"select"}},footerInfo:{table:{type:{summary:["string: NoFooterInfo, WithFooterInfo"]}},options:["NoFooterInfo","WithFooterInfo"],control:{type:"select"}},footerAction:{table:{type:{summary:["string: NoLink, InternalLink, ExternalLink"]}},options:["NoLink","InternalLink","ExternalLink"],control:{type:"select"}}},decorators:[()=>({template:'<div style="padding:3rem; background:var(--background-accent-01)"><story/></div>'})]},n={render:e=>({components:{Card:g,MetaInfo:f,SvgIcon:b},template:`
      <div style="${e.layout!=="list"?"max-width: 600px; margin: auto":""}">
        <Card :type="type" :layout="layout"
          :has-icon="${e.image=="WithIcon"}">
          <template v-if="${e.image!="NoImage"}" v-slot:image>
            <img
              v-if="${e.image=="WithImage"}"
              src="https://picsum.photos/775/350"
              alt="cat">
            <SvgIcon
              v-if="${e.image=="WithIcon"}"
              icon="Balance"
              size="xl"
            />
          </template>
          <template v-if="${e.header=="WithHeader"}" v-slot:header>
            <svg viewBox="0 0 24 24" class="mr-2 icon icon--xl icon--xCorp ">
              <path
            ...
            <div>Posts from @swiss_geoportal</div>
          </template>
          <template v-slot:metaInfos>
            <MetaInfo
              v-if="${e.metaInfo=="WithMetaInfo"}"
          ...
          <template v-slot:specifications>
            <MetaInfo v-if="${e.contentSpecs=="WithContentSpecs"}" :metainfos="['PDF', '2.34mb']" />
          </template>
          <template v-slot:contentIcons>
            <div
              v-if="${e.contentIcons=="WithContentIcons"}"
          ...
          <template v-if="${e.footerInfo=="WithFooterInfo"}" v-slot:footerInfo>
            <div>Energie, Datenmodell, Nachhaltigkeit</div>
          </template>
          <template
            v-if="${e.footerAction=="InternalLink"||e.footerAction=="ExternalLink"}"
            v-slot:footerAction>
            <a href="#" v-if="${e.footerAction=="InternalLink"}"
            ...
            <a href="#" v-if="${e.footerAction=="ExternalLink"}"
      ...
      </div>`}),args:{type:"default",layout:"default",image:"WithImage",metaInfo:"WithMetaInfo",contentSpecs:"WithContentSpecs",contentIcons:"WithContentIcons",header:"NoHeader",footerInfo:"WithFooterInfo",footerAction:"InternalLink",body:"Lorem "}},t={render:()=>({template:`
  ...
  <div class="grid socials__grid gap--responsive">
    ...
    <div class="card card--default card--clickable">
      <div class="card__header">
        ...
        >
          <path
            d="M13.2331 11.0063L18.0708 5.5H16.9214L12.7238 10.2797L9.37017 5.5H5.5L10.5705 12.7301L5.5 18.5H6.64941L11.087 13.4496L14.6298 18.5H18.5L13.2403 11.0063H13.2331ZM11.6617 12.7942L11.1452 12.0748L7.0568 6.34767H8.81729L12.12 10.9707L12.6365 11.6901L16.9287 17.6951H15.1682L11.669 12.7942H11.6617Z"
            fill="black"
          />
        </svg>
        <div>Press-release on 𝕏</div>
      </div>

      <div class="card__content">
        <div class="card__body">Last 𝕏 feed here</div>
    ...
    template: \`
      <div style="\${args.layout !== 'list' ? 'max-width: 600px; margin: auto' : ''}">
        <Card :type="type" :layout="layout"
          ...
          <template
            v-if="\${args.footerAction == 'InternalLink' || args.footerAction == 'ExternalLink'}"
            v-slot:footerAction>
...
}`,...(c=(o=n.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var l,r,d;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="grid grid--responsive-cols-1/2-1/2 gap--responsive">
        <div class="card card--default card--clickable">
...
}`,...(d=(r=t.parameters)==null?void 0:r.docs)==null?void 0:d.source}}};var v,m,p;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="grid grid--responsive-cols-3 gap--responsive">
        <div class="card card--default card--clickable">
...
}`,...(p=(m=i.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};var _,u,h;a.parameters={...a.parameters,docs:{...(_=a.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => ({
    template: \`
    <div class="socials socials--items-1">
  <div class="grid socials__grid gap--responsive">
...
}`,...(h=(u=a.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};const x=["Example","DefaultCard","UniversalCard","SocialCard"],L=Object.freeze(Object.defineProperty({__proto__:null,DefaultCard:t,Example:n,SocialCard:a,UniversalCard:i,__namedExportsOrder:x,default:I},Symbol.toStringTag,{value:"Module"}));export{L as C,t as D,n as E,a as S,i as U};
