import{_ as g}from"./Card-BUaOwynk.js";import{_ as f}from"./MetaInfo-3xQwXXuy.js";import{_ as b}from"./SvgIcon-CpZw2VHn.js";const I={title:"Components/Card",component:g,argTypes:{type:{table:{type:{summary:["string: default, highlight, twitter, flat, universal, list"]}},options:["default","highlight","twitter","flat","universal","list"],control:{type:"select"}},layout:{table:{type:{summary:["string: default, image-left, image-right"]}},options:["default","image-left","image-right"],control:{type:"select"}},image:{table:{type:{summary:["string: NoImage, WithImage, WithIcon"]}},options:["NoImage","WithImage","WithIcon"],control:{type:"select"}},header:{table:{type:{summary:["string: NoHeader, WithHeader"]}},options:["NoHeader","WithHeader"],control:{type:"select"}},metaInfo:{table:{type:{summary:["string: NoMetaInfo, WithMetaInfo"]}},options:["NoMetaInfo","WithMetaInfo"],control:{type:"select"}},contentSpecs:{table:{type:{summary:["string: NoContentSpecs, WithContentSpecs"]}},options:["NoContentSpecs","WithContentSpecs"],control:{type:"select"}},contentIcons:{table:{type:{summary:["string: NoContentIcons, WithContentIcons"]}},options:["NoContentIcons","WithContentIcons"],control:{type:"select"}},footerInfo:{table:{type:{summary:["string: NoFooterInfo, WithFooterInfo"]}},options:["NoFooterInfo","WithFooterInfo"],control:{type:"select"}},footerAction:{table:{type:{summary:["string: NoLink, InternalLink, ExternalLink"]}},options:["NoLink","InternalLink","ExternalLink"],control:{type:"select"}}},decorators:[()=>({template:'<div style="padding:3rem; background:var(--background-accent-01)"><story/></div>'})]},t={render:e=>({components:{Card:g,MetaInfo:f,SvgIcon:b},template:`
      ...
      </div>`}),args:{type:"default",layout:"default",image:"WithImage",metaInfo:"WithMetaInfo",contentSpecs:"WithContentSpecs",contentIcons:"WithContentIcons",header:"NoHeader",footerInfo:"WithFooterInfo",footerAction:"InternalLink",body:"Lorem "}},n={render:()=>({template:`
    ...
    `})};var s,o,c;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{
  render: args => ({
    components: {
      Card,
      MetaInfo,
...
}`,...(c=(o=t.parameters)==null?void 0:o.docs)==null?void 0:c.source}}};var l,r,d;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="grid grid--responsive-cols-1/2-1/2 gap--responsive">
        <div class="card card--default card--clickable">
...
}`,...(d=(r=n.parameters)==null?void 0:r.docs)==null?void 0:d.source}}};var v,m,p;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: () => ({
    template: \`
      <div class="grid grid--responsive-cols-3 gap--responsive">
        <div class="card card--default card--clickable">
...
}`,...(h=(u=a.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};const y=["Example","DefaultCard","UniversalCard","SocialCard"],k=Object.freeze(Object.defineProperty({__proto__:null,DefaultCard:n,Example:t,SocialCard:a,UniversalCard:i,__namedExportsOrder:y,default:I},Symbol.toStringTag,{value:"Module"}));export{k as C,n as D,t as E,a as S,i as U};
