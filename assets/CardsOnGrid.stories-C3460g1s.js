import{_ as N}from"./Card-CvOquYcC.js";import{_ as j}from"./Btn-B1NleKrw.js";import{_ as q}from"./SvgIcon-DJ1DxYZI.js";import{q as x,p as F,c as W,H as z,v as D,o as $}from"./vue.esm-bundler-BiTVOWp5.js";const c=x({__name:"CardGrid",props:{nItems:{type:Number,validator:a=>typeof a!="number"?!1:a>0&&a<6,default:()=>{}}},setup(a){const n=a,R=F(()=>{let t="grid gap--responsive ";return n.nItems===1?t+="grid--items-1 ":n.nItems===2?t+="grid--items-2 ":n.nItems===3?t+="grid--items-3 ":n.nItems===4?t+="grid--items-4 ":n.nItems===5&&(t+="grid--items-5 "),t});return(t,M)=>($(),W("div",{class:D(R.value)},[z(t.$slots,"default")],2))}});c.__docgenInfo={exportName:"default",displayName:"CardGrid",description:"",tags:{},props:[{name:"nItems",type:{name:"number"},defaultValue:{func:!0,value:"() => undefined"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/nwgl-designsystem/nwgl-designsystem/app/components/ch/demo/CardGrid.vue"]};const E={title:"Components/Card/Cards and grids",components:c},s={render:()=>({template:`
