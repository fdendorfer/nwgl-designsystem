import{_ as N}from"./Card-BUaOwynk.js";import{_ as j}from"./Btn-BjlVMAnt.js";import{_ as q}from"./SvgIcon-CpZw2VHn.js";import{q as x,g as F,k as W,H as z,v as D,p as $}from"./vue.esm-bundler-C14dN-al.js";const c=x({__name:"CardGrid",props:{nItems:{type:Number,validator:a=>typeof a!="number"?!1:a>0&&a<6,default:()=>{}}},setup(a){const n=a,R=F(()=>{let t="grid gap--responsive ";return n.nItems===1?t+="grid--items-1 ":n.nItems===2?t+="grid--items-2 ":n.nItems===3?t+="grid--items-3 ":n.nItems===4?t+="grid--items-4 ":n.nItems===5&&(t+="grid--items-5 "),t});return(t,M)=>($(),W("div",{class:D(R.value)},[z(t.$slots,"default")],2))}});c.__docgenInfo={exportName:"default",displayName:"CardGrid",description:"",tags:{},props:[{name:"nItems",type:{name:"number"},defaultValue:{func:!0,value:"() => undefined"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/nwgl-designsystem/nwgl-designsystem/app/components/ch/demo/CardGrid.vue"]};const E={title:"Components/Card/Cards and grids",components:c},s={render:()=>({template:`
...
}`,...(I=(f=i.parameters)==null?void 0:f.docs)==null?void 0:I.source}}};var A,w,S;r.parameters={...r.parameters,docs:{...(A=r.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...OneCard,
  args: {
    sectionTitle: 'Three Cards',
    nItems: 3
  }
}`,...(S=(w=r.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};var k,L,T;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  ...OneCard,
  args: {
