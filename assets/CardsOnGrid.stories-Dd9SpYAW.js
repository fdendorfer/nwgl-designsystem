import{_ as N}from"./Card-DMic048D.js";import{_ as j}from"./Btn-ByR9kGXl.js";import{_ as x}from"./SvgIcon-CvLaVXkC.js";import{s as q,g as F,k as W,H as z,x as D,p as $}from"./vue.esm-bundler-B8GkW3lv.js";const c=q({__name:"CardGrid",props:{nItems:{type:Number,validator:a=>typeof a!="number"?!1:a>0&&a<6,default:()=>{}}},setup(a){const s=a,R=F(()=>{let t="grid gap--responsive ";return s.nItems===1?t+="grid--items-1 ":s.nItems===2?t+="grid--items-2 ":s.nItems===3?t+="grid--items-3 ":s.nItems===4?t+="grid--items-4 ":s.nItems===5&&(t+="grid--items-5 "),t});return(t,M)=>($(),W("div",{class:D(R.value)},[z(t.$slots,"default")],2))}});c.__docgenInfo={exportName:"default",displayName:"CardGrid",description:"",tags:{},props:[{name:"nItems",type:{name:"number"},defaultValue:{func:!0,value:"() => undefined"}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/nwgl-designsystem/nwgl-designsystem/app/components/ch/demo/CardGrid.vue"]};const E={title:"Components/Card/Cards and grids",components:c},n={render:()=>({template:`
...
}`,...(I=(f=r.parameters)==null?void 0:f.docs)==null?void 0:I.source}}};var A,w,S;i.parameters={...i.parameters,docs:{...(A=i.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...OneCard,
  args: {
    sectionTitle: 'Three Cards',
    nItems: 3
  }
}`,...(S=(w=i.parameters)==null?void 0:w.docs)==null?void 0:S.source}}};var k,L,T;d.parameters={...d.parameters,docs:{...(k=d.parameters)==null?void 0:k.docs,source:{originalSource:`{
  ...OneCard,
  args: {
