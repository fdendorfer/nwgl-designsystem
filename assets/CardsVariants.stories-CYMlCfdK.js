import{_ as i}from"./Card-BUaOwynk.js";import{_ as m}from"./Btn-BjlVMAnt.js";import{_ as n}from"./SvgIcon-CpZw2VHn.js";import{_ as w}from"./SubpagesSection-CWwY5MqH.js";const y=e=>({setup:()=>({...e}),components:{Card:i,Btn:m,SvgIcon:n},template:`
    <div>
    ...
    </div>`}),O=e=>({setup:()=>({...e}),components:{SubpagesSection:w},template:"<SubpagesSection />"}),k={title:"Components/Card/Cards variants",components:n},t={render:y,args:{type:"default"}},a={render:y,name:"News item, optional image",args:{type:"universal"}},s={render:A,args:{}},r={render:T,args:{}},o={render:O.bind({}),args:{}};var l,p,d;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...
  args: {}
}`,...(b=(f=s.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var h,C,_;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: TemplateCardShare,
  args: {}
}`,...(_=(C=r.parameters)==null?void 0:C.docs)==null?void 0:_.source}}};var S,x,I;o.parameters={...o.parameters,docs:{...(S=o.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: TemplateCardHub.bind({}),
  args: {}
}`,...(I=(x=o.parameters)==null?void 0:x.docs)==null?void 0:I.source}}};const z=["ArticleOrNewsItem","NewsItemOptionalImage","EventItem","SharingItem","HubPageItem"],N=Object.freeze(Object.defineProperty({__proto__:null,ArticleOrNewsItem:t,EventItem:s,HubPageItem:o,NewsItemOptionalImage:a,SharingItem:r,__namedExportsOrder:z,default:k},Symbol.toStringTag,{value:"Module"}));export{t as A,N as C,s as E,o as H,a as N,r as S};
