import{q as O,g as k,k as w,A as C,v as V,p as q}from"./vue.esm-bundler-C14dN-al.js";const E=O({__name:"Fonts",props:{label:{type:String,required:!0},textStyle:{type:String,default:()=>"regular",validator:e=>["regular","italic","bold","bold-italic"].includes(e)},size:{type:String,default:()=>"base",validator:e=>["3xl","2xl","xl","lg","base","sm","xs"].includes(e)}},setup(e){const s=e,H=k(()=>{let t="";return s.textStyle&&(t+=`font--${s.textStyle} `),s.size&&(s.size.startsWith("h")?t+=`${s.size} `:t+=`text--${s.size} `),t});return(t,j)=>(q(),w("div",{class:V(H.value)},C(e.label),3))}});E.__docgenInfo={exportName:"default",displayName:"Fonts",description:"",tags:{},props:[{name:"label",type:{name:"string"},required:!0},{name:"textStyle",type:{name:"string"},defaultValue:{func:!0,value:"() => 'regular'"},values:["regular","italic","bold","bold-italic"]},{name:"size",type:{name:"string"},defaultValue:{func:!0,value:"() => 'base'"},values:["3xl","2xl","xl","lg","base","sm","xs"]}],sourceFiles:["/home/runner/work/nwgl-designsystem/nwgl-designsystem/app/components/ch/foundations/Fonts.vue"]};const I={title:"Foundations/Fonts/Sizes and styles",component:E,argTypes:{textStyle:{name:"style and weight",options:["regular","italic","bold","bold-italic"],control:{type:"select"}},size:{options:["3xl","2xl","xl","lg","base","sm","xs"],control:{type:"select"}}}},i={render:()=>({template:`<div>
...
}`,...(B=(F=n.parameters)==null?void 0:F.docs)==null?void 0:B.source}}};const $=["Headings","TextSize","StyleVariations","Superscript","Subscript","Example"],R=Object.freeze(Object.defineProperty({__proto__:null,Example:n,Headings:i,StyleVariations:l,Subscript:d,Superscript:r,TextSize:a,__namedExportsOrder:$,default:I},Symbol.toStringTag,{value:"Module"}));export{n as E,R as F,i as H,l as S,a as T,r as a,d as b};
