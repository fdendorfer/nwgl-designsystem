import{_ as s}from"./Newsletter-WHQSz7ru.js";const g={title:"Components/Newsletter",component:s,argTypes:{type:{table:{type:{summary:["string: default, inline"]}},options:["default","inline"],control:{type:"select"}},theme:{table:{type:{summary:["string?: light, dark"]}},options:[null,"light","dark"],control:{type:"select"}},state:{table:{category:"props",type:{summary:["string: default, sent"]}},options:["default","sent"],control:{type:"select"}}}},e={render:n=>({components:{Newsletter:s},setup:()=>({args:n}),template:`
